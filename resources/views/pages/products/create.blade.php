                ...
                <div id='general' class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 ">
                  ...
                  <div class="md:col-span-5 mt-2">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="text" id="extract" name="extract" value="{{ old('extract') }}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
              ...
              <div class=" grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5 rounded shadow-lg p-4 px-4 ">
                ...
                {{-- <div class="md:col-span-5 flex flex-col justify-start gap-2">
                                ...
                                <div class="flex justify-start gap-8">
                                    <div class="flex justify-center items-center gap-2">
                                        ...
                                        <input type="radio" id="alquiler" name="tipoPropiedad" value="alquiler" class="cursor-pointer">
                                    </div>
    
                                    <div class="flex justify-center items-center gap-2">
                                        <label for="comprar">Venta</label>
                                        <input type="radio" id="comprar" name="tipoPropiedad" value="comprar" class="cursor-pointer">
                                    </div>
                                </div>
                            </div> --}}
                ...
                <div class="md:col-span-5 flex justify-between gap-4">
                  <div class="w-full">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="number" id="cuartos" name="cuartos" value="{{ old('cuartos') }}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="cuartos">
                    </div>
                  ...
                  <div class="w-full">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="number" id="banios" name="banios" value="{{ old('banios') }}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="baños">
                    </div>
                    @error('banios')
                ...
                <div class="md:col-span-5 flex justify-between gap-4">
                  ...
                  <div class="w-full">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="number" id="cochera" name="cochera" value="{{ old('cochera') }}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                        placeholder="Cochera">
                    </div>
                    @error('cochera')
                ...
                <div class="md:col-span-5 flex justify-between gap-4">
                  <div class="w-full">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="number" id="pisos" name="pisos" value="{{ old('pisos') }}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  ...
                  <div class="w-full">
                    ...
                    <div class="relative mb-2  mt-2">
                      ...
                      <input type="text" id="movilidad" name="movilidad" value="{{ old('movilidad') }}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="md:col-span-5 mt-2">
                  ...
                  <div class="relative mb-2 ">
                    ...
                    <input type="text" id="frecuencia" name="frecuencia" value="{{ old('frecuencia') }}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="Frecuencia de la propiedad">
                  </div>
                  @error('frecuencia')
                    <span class="text-red-500">{{ $message }}</span>
                  @enderror
                ...
                {{-- <div class="md:col-span-5 mt-2">
                                    ...
                                    <div class="relative mb-2  mt-2">
                                        ...
                                        <input type="text" id="frecuencia" name="frecuencia" value=""
                                            class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Frecuencia mensual o anual">
                                    </div>
                                </div> --}}
                  ...
                  <div class="w-full flex justify-start gap-5">
                    <div class="flex justify-start gap-2 items-center">
                      ...
                      <input type="radio" name="tipo_propiedad" value="alquiler"
                        {{ old('tipo_propiedad') == 'alquiler' ? 'checked' : '' }}>
                    </div>
                    ...
                    <div class="flex justify-start gap-2 items-center">
                      ...
                      <input type="radio" name="tipo_propiedad" value="comprar"
                        {{ old('tipo_propiedad') == 'comprar' ? 'checked' : '' }}>
                    </div>
                ...
                <div class="md:col-span-5 mt-2">
                  ...
                  <div class="relative mb-2">
                    ...
                    <input type="text" id="inside" name="inside" value="{{ old('inside') }}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="md:col-span-5 mt-2">
                  ...
                  <div class="relative mb-2  mt-2">
                    ...
                    <input type="text" id="incluye" name="incluye" value="{{ old('incluye') }}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                      placeholder="Incluye">
                ...
                <div class="md:col-span-5 mt-2">
                  ...
                  <div class="relative mb-2  mt-2">
                    ...
                    <input type="text" id="no_incluye" name="no_incluye" value="{{ old('no_incluye') }}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="md:col-span-5 mt-2">
                  ...
                  <div class="relative mb-2  mt-2">
                    ...
                    <input type="text" id="propietario" name="propietario" value="{{ old('propietario') }}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                ...
                <div class="md:col-span-5">
                  <label for="imagen_propietario">Foto del propietario</label>
                  <div class="relative mb-2  mt-2">
                    <input id="imagen_propietario" name="imagen_propietario"
                      class="p-2.5 block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                      aria-describedby="user_avatar_help" id="user_avatar" type="file">
                  </div>
