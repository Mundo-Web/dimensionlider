          ...
          <div class="flex gap-2 p-3 ">
              ...
              <div class="md:col-span-5 flex flex-col justify-between gap-4">
                ...
                <div class="w-full flex justify-start gap-5">
                    <div class="flex justify-start gap-2 items-center">
                       ...
                       {{--  <span class="text-red-500">{{$product->tipo_propiedad}}</span> --}}
                        <input type="radio" name="tipo_propiedad" value="alquiler" @checked($product->tipo_propiedad == 'alquiler')>
                    </div>

                    <div class="flex justify-start gap-2 items-center">
                        <label for="comprar">Comprar</label>
                        <input type="radio" name="tipo_propiedad" value="comprar" @checked($product->tipo_propiedad == 'comprar')>
                    </div>

                    <div class="flex justify-start gap-2 items-center">
                      <label for="vender">Vender</label>
                      <input type="radio" name="tipo_propiedad" value="vender" @checked($product->tipo_propiedad == 'vender')>
                  </div>
                </div>
              </div>
            ...
            <div class="md:col-span-5 mt-2">
                ...
                <div class="relative mb-2">
                    ...
                    <input type="text" id="inside" name="inside" value="{{$product->inside}}"
                        class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div class="md:col-span-5 mt-2">
              ...
              <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="propietario" name="propietario" value="{{$product->propietario}}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div class="md:col-span-5 mt-2">
              ...
              <div class="relative mb-2  mt-2">
                  ...
                  <input type="text" id="tipo_propietario" name="tipo_propietario"
                      value="{{$product->tipo_propietario}}"
                      class="mt-1 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
