<x-app-layout>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        ...
        <section class="py-4 border-b border-slate-100 dark:border-slate-700">
            <a href="{{ route('categoriasBlog.create') }}"
                            ...
                            @foreach ($category as $item)
                                <tr>
                                    ...
                                    <td class="dark:bg-slate-800">
                                        <form method="POST" action="">
                                            ...
                                            before:transform before:ring-0 before:transition before:ease-in-out before:duration-200 dark:before:bg-gray-400 dark:checked:before:bg-blue-200"
                                                id='{{ 'd_' . $item->id }}' data-field='destacar'
                                                data-idService='{{ $item->id }}'
                                                data-titleService='{{ $item->name }}'
                                                {{ $item->destacar == 1 ? 'checked' : '' }}>
                                    ...
                                    <td class="flex flex-row justify-end items-center gap-5 dark:bg-slate-800">
                                        ...
                                        <a href="{{ route('categoriasBlog.edit', $item->id) }}"
    ...
    <script>
        $('document').ready(function() {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            ...
                            url: '{{ route('categoriasBlog.deleteCategory') }}',
                            method: 'POST',
                            data: {
            ...
            $(".btn_swithc").on("change", function() {
                ...
                $.ajax({
                    url: "{{ route('categoriasBlog.updateVisible') }}",
                    method: 'POST',
                    data: {
                        _token: $('input[name="_token"]').val(),
                        status: status,
