  ...
  <main>
            ...
            <div id="tab2"
              ...
              <div class="hidden md:block w-full">
                <div class="relative w-full text-left">
                  <div class="group">
                    <div>
                      <select name="departamento_id" id="categoria_id"
                        class="w-full py-3 px-5 text-text18 text-[#000929] border-0">
                        <option value="">Categorias</option>
                        @foreach ($categorias as $categoria)
                          @if ($categoria->tipo_propiedad !== 'alquiler')
        ...
        <div class=" items-center w-11/12 mx-auto pt-10 md:pt-20 pb-20">
          <div data-aos="fade-up" data-aos-duration="150">
            <div class="flex flex-col gap-2 items-center">
              ...
              <p class="text-[#000929] text-text16 font-satoshiRegular opacity-70 text-center w-full md:w-[400px]">
                  ...
                  <div class="swiper-slide">
                    <div class="flex flex-col gap-5 items-center">
                      ...
                      <div class="flex justify-center items-center gap-10">
                        <div class="flex justify-center items-center">
                          <img src="{{ asset($item->imagen_testimonio) }}" alt="" class="rounded-full" />
                        </div>
                      </div>
                    </div>
                  </div>
    ...
    <section class="bg-[#FAFAFA] lg:bg-white pt-20">
      <div class="bg-[#F7F7FD] flex flex-col gap-10 md:gap-16 py-16">
        ...
        <div class="flex flex-col gap-5">
          <form action="" id="indexPropFormulario" class="md:w-[630px] w-11/12 mx-auto">
            @csrf
            <div class="bg-[#FFFFFF] flex flex-row justify-between px-3 md:px-5 py-5 items-center">
              <input type="email" name="email" id="emailIndex"
...
@section('scripts_importados')
  ...
  <script>
    ...
    $('#indexPropFormulario').submit(function(e) {
  ...
  `,
      ...
      if (!validarEmail($('#emailIndex').val())) {
        return;
      };
      $.ajax({
        url: '{{ route('guardarUserNewsLetter') }}',
